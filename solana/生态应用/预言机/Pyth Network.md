...
Pyth Network 是专为高频金融应用设计的预言机网络，为 Solana 和多条区块链提供实时、高精度的价格数据。Pyth 由传统金融机构和加密交易所直接提供数据，是 DeFi 领域数据质量最高的预言机之一。
...
**2. 一手数据源**
数据直接来自：
- 顶级加密交易所（Binance、OKX、Bybit 等）
- 做市商（Jump、Jane Street 等）
- 传统金融机构
