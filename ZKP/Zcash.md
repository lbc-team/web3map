...
Zcash 的诞生源于对比特币隐私保护能力的改进需求。在商业应用和个人财务管理中，完全公开的账本（如[比特币](https://learnblockchain.cn/tags/比特币?map=BTC)）虽然透明，但也暴露了过多的敏感信息。Zcash 试图在**监管合规**（需要审计时可披露）和**极致隐私**（无需披露时完全保密）之间找到平衡点。
...
*   **公开交易 (t-to-t)**：类似[比特币](https://learnblockchain.cn/tags/比特币?map=BTC)，无隐私。
*   **屏蔽 (t-to-z)**：资金从透明地址转入屏蔽池，切断资金链路。
*   **去屏蔽 (z-to-t)**：资金从屏蔽池转出到透明地址。
*   **完全屏蔽 (z-to-z)**：发送方、接收方和金额均在区块链上加密，只有拥有查看密钥（Viewing Key）的人可见。

### 协议升级历程
Zcash 的[零知识证明](https://learnblockchain.cn/tags/%E9%9B%B6%E7%9F%A5%E8%AF%86%E8%AF%81%E6%98%8E)技术经历了多次重大迭代：
*   **Sprout (2016)**：最初的版本，生成证明极其缓慢且需要大量的内存，需要可信设置（Trusted Setup）。
*   **Sapling (2018)**：革命性的升级，将证明生成时间从几分钟缩短到几秒钟，大幅降低了内存需求，使得移动设备[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)支持屏蔽交易成为可能。
*   **Orchard (2022)**：作为 NU5 升级的一部分，引入了 Halo 2 证明系统，消除了对可信设置的依赖（Trustless），进一步增强了安全性和可扩展性。

### 可选披露
Zcash 的一个关键特性是**查看密钥 (Viewing Keys)** 和 **支付披露 (Payment Disclosure)**。用户可以主动分享特定的交易细节给第三方（如审计员、税务机构），以证明合规性，而不会公开整个[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)的历史。

## 主要特点

*   **科学严谨性**：Zcash 由顶尖的密码学家团队（包括 [ZKP](https://learnblockchain.cn/tags/zkp) 的发明者之一）开发，致力于将最新的学术成果转化为工程实践。
