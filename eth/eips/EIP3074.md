...
EIP-3074 是一项提议的[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)升级，旨在通过引入两个新的操作码 `AUTH` 和 `AUTHCALL`，赋予外部拥有账户（EOA）类似智能合约的功能。
...
*   **Gas 代付:** Invoker 可以支付 [Gas](https://learnblockchain.cn/tags/Gas?map=EVM)，用户无需持有 ETH。
*   **安全性:** 高度依赖 Invoker 合约的安全性。如果是恶意的 Invoker，可能会窃取用户资产。因此，预计未来[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)会通过白名单机制限制用户可以授权的 Invoker。

### 状态
EIP-3074 之前计划过纳入[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)硬分叉升级中（如 Pectra 升级），但社区最终采纳了 [EIP-7702](https://learnblockchain.cn/tags/EIP7702?map=EVM) 

### 推荐阅读
*   [EIP-3074 Standard](https://learnblockchain.cn/docs/eips/EIPS/eip-3074)
