...
ERC-7786（Cross-Chain Messaging Gateway）是[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)的跨链消息传递网关标准，于 2024 年 10 月发布。这个标准提供了一个统一的接口，用于合约之间发送和接收包含任意数据的跨链消息，旨在解决当前跨链通信协议碎片化的问题。

ERC-7786 是[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)基金会互操作性工作组（Interoperability Working Group）倡议的一部分，致力于创建真正可互操作的区块链生态系统。
...
**执行 [Gas](https://learnblockchain.cn/tags/Gas?map=EVM) 限制**
```solidity
...
**跨链 [DeFi](https://learnblockchain.cn/tags/DeFi?map=EVM)**
```solidity
...
**跨链 [NFT](https://learnblockchain.cn/tags/NFT)**
```solidity
// NFT 在链间移动
...
- Wormhole
- Axelar
- [Chainlink](https://learnblockchain.cn/tags/Chainlink) CCIP

**应用集成**
- 跨链 [DEX](https://learnblockchain.cn/tags/DEX?map=EVM)
- 多链 DAO
- 跨链游戏
- 统一流动性池
...
**[OpenZeppelin](https://learnblockchain.cn/tags/OpenZeppelin?map=EVM) 合约**
```solidity
...
- 更多协议采用 ERC-7786
- 标准库和工具成熟
- [钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)和区块浏览器支持
...
- [ERC-7786 官方规范](https://learnblockchain.cn/docs/eips/EIPS/eip-7786)
