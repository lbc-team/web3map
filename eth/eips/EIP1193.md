...
EIP-1193（Ethereum Provider JavaScript API）是以太坊提供者的标准 JavaScript API 规范，定义了浏览器钱包（如 MetaMask）与 Web3 应用（DApp）之间的通信接口。这个标准统一了不同钱包的 API 行为，使开发者能够编写兼容所有符合标准的钱包的 DApp。
...
**提供者（Provider）**
提供者是一个 JavaScript 对象，提供对以太坊的访问：
- 暴露标准的 API 方法
- 发出标准化的事件
- 处理 RPC 请求
...
- [EIP-1193 官方规范](https://eips.ethereum.org/EIPS/eip-1193)
