...
ERC-6909（Minimal Multi-Token Interface）是[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)的最小化多代币接口标准，是 ERC-1155 的简化和优化版本。这个标准保留了多代币管理的核心功能，同时移除了 ERC-1155 中的冗余特性，提供了更高的 Gas 效率和更灵活的权限系统。
...
**第一层：Allowance（细粒度）**
类似 [ERC-20](https://learnblockchain.cn/tags/ERC20?map=EVM) 的 approve/allowance：
- 授权特定数量的特定代币
- 精确控制权限
- 使用后减少额度
...
**第二层：Operator（全局授权）**
类似 [ERC-721](https://learnblockchain.cn/tags/ERC721?map=EVM)/1155 的 setApprovalForAll：
- 授权所有代币的所有操作
- 适合信任的合约（如交易市场）
- 一次授权，无限使用
...
| 特性 | [ERC-1155](https://learnblockchain.cn/tags/ERC1155?map=EVM) | ERC-6909 |
|------|----------|----------|
| 回调函数 | 强制 | 无 |
| 批量操作 | 内置 | 可选扩展 |
...
- 避免每次交易都转移 [ERC-20](https://learnblockchain.cn/tags/ERC20?map=EVM) 代币
...
- AMM（如 [Uniswap](https://learnblockchain.cn/tags/Uniswap?map=EVM) V4）
- 借贷协议的仓位代币
- 期权和衍生品
- 合成资产
...
- 多种游戏道具
- 资源和货币
- 角色和 [NFT](https://learnblockchain.cn/tags/NFT)
...
**[Gas](https://learnblockchain.cn/tags/Gas?map=EVM) 效率**
- 无强制回调：节省 ~20,000 gas
- 简化逻辑：更少的计算
- 优化的存储布局
...
- 管理内部余额
- 表示流动性头寸
- 优化 [Gas](https://learnblockchain.cn/tags/Gas?map=EVM) 成本
...
- 更多协议采用
- 工具和库支持
- [钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)集成
...
**竞争格局**
- [ERC-1155](https://learnblockchain.cn/tags/ERC1155?map=EVM) 仍有其优势（回调、批量）
- ERC-6909 更适合 [DeFi](https://learnblockchain.cn/tags/DeFi?map=EVM)
- 两者将长期共存

### 相关链接

- [ERC-6909 官方规范](https://learnblockchain.cn/docs/eips/EIPS/eip-6909)
