...
ERC-2771（Secure Protocol for Native Meta Transactions）是以太坊的元交易安全协议标准，定义了一种合约级协议，使接收者合约能够通过可信的转发者（Forwarder）合约安全地接受元交易（Meta Transactions）。
...
- [ERC-2771 官方规范](https://eips.ethereum.org/EIPS/eip-2771)
