...
EIP-6963（Multi Injected Provider Discovery）是[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)的多钱包发现标准，于 2023 年 10 月被正式接受。这个标准解决了浏览器中多个钱包扩展共存时的发现和选择问题，使用基于事件的机制让 DApp 能够发现并连接到所有已安装的钱包。
...
- 支持旧版 DApp
- 新 [DApp](https://learnblockchain.cn/tags/DApp) 使用 EIP-6963
- 平滑过渡
...
- Zerion
- Rabby
- [Phantom](https://learnblockchain.cn/tags/Phantom?map=Solana)（计划中）
...
- 主流钱包陆续支持
- 新钱包默认实现
- [DApp](https://learnblockchain.cn/tags/DApp) 框架集成
...
EIP-5792 定义了钱包能力：
- 发现钱包（EIP-6963）
- 查询[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)能力（EIP-5792）
- 完整的[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)生态系统

### 相关链接

- [EIP-6963 官方规范](https://learnblockchain.cn/docs/eips/EIPS/eip-6963)
