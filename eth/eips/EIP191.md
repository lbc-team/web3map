...
- 用途：绑定到特定的验证合约
- 场景：合约签名验证
- 示例：特定[智能合约](https://learnblockchain.cn/tags/%E6%99%BA%E8%83%BD%E5%90%88%E7%BA%A6)验证的签名
...
- [以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)交易的 RLP 编码不会以 0x19 开头
- 签名消息永远不会被误认为交易
- 完全防止签名重放攻击
...
**[Solidity](https://learnblockchain.cn/tags/Solidity?map=EVM) 验证**
```solidity
...
**[JavaScript](https://learnblockchain.cn/tags/JavaScript) 签名和验证**
```javascript
...
**使用 [OpenZeppelin](https://learnblockchain.cn/tags/OpenZeppelin?map=EVM)**
```solidity
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";
...
**钱包标准化**
所有主流[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)都支持 EIP-191：
- MetaMask
- WalletConnect
- Coinbase Wallet
- Ledger, Trezor 等硬件[钱包](https://learnblockchain.cn/tags/%E9%92%B1%E5%8C%85)

**开发工具支持**
标准库内置支持：
- Ethers.js：`signMessage()`, `verifyMessage()`
- Web3.js：`eth.personal.sign()`, `eth.personal.ecRecover()`
- [OpenZeppelin](https://learnblockchain.cn/tags/OpenZeppelin?map=EVM)：ECDSA 库

**[DApp](https://learnblockchain.cn/tags/DApp) 集成**
EIP-191 已成为：
- 登录验证的事实标准
- 链下签名的基础
- EIP-712 的基石
...
EIP-191 是[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)生态系统中的重要基础设施：
...
- [EIP-191 官方规范](https://learnblockchain.cn/docs/eips/EIPS/eip-191)
