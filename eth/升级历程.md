...
**[EVM](https://learnblockchain.cn/tags/EVM?map=EVM) 升级**  2016 - 2021

五年内进行了六次硬分叉，升级了 [EVM](https://learnblockchain.cn/tags/EVM?map=EVM)，并且独立于信标链，尽管最后几次变化是为准备工作。

**上海升级** 2023 年 4 月 12 日

启用了从信标链中提取验证者的功能，完成了向 [PoS](https://learnblockchain.cn/tags/PoS) 的过渡。

**坎昆升级**  2024 年 3 月 13 日

加入了[瞬时存储](https://learnblockchain.cn/tags/瞬态存储)

通过 EIP-4844 和 Blobs 以及其他辅助改进扩展了 [Layer2](https://learnblockchain.cn/tags/Layer2?map=EVM)。
...
这标志着[以太坊](https://learnblockchain.cn/tags/以太坊?map=EVM)向权益证明共识机制过渡的开始，也是现在的共识层的创世。
