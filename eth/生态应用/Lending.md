...
去中心化借贷（Decentralized Lending）是 [DeFi](https://learnblockchain.cn/tags/DeFi?map=EVM) 生态系统中的核心支柱之一，它允许用户在不需要银行或信用审查机构等中介的情况下，通过智能合约进行资产的存入（借出）和借取。
...
利率不是由中央机构设定，而是由[智能合约](https://learnblockchain.cn/tags/%E6%99%BA%E8%83%BD%E5%90%88%E7%BA%A6)算法根据**资金利用率**（Utilization Rate）动态调整。
- **利用率低**（资金充裕）：借款利率低，鼓励借款。
- **利用率高**（资金紧缺）：借款利率指数级上升，抑制借款并激励还款/存款。

### 4. 闪电贷 (Flash Loans)
Aave 首创的 [DeFi](https://learnblockchain.cn/tags/DeFi?map=EVM) 原生功能，允许开发者在一个区块的一笔交易内借出无需抵押的巨额资金，前提是必须在同一笔交易结束前归还本金加利息。如果未归还，整笔交易回滚，就像从未发生过一样。这常用于套利、清算和资产重组。
...
- **[智能合约](https://learnblockchain.cn/tags/%E6%99%BA%E8%83%BD%E5%90%88%E7%BA%A6)风险**：代码漏洞可能导致资金池被黑客盗取。
- **[预言机](https://learnblockchain.cn/tags/%E9%A2%84%E8%A8%80%E6%9C%BA)风险**：如果喂价机制被操纵，可能导致错误的清算或坏账。
